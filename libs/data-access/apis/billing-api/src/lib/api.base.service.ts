...
export class BaseService {
    ...
    public configuration: BillingConfiguration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: BillingConfiguration) {
        this.configuration = configuration || new BillingConfiguration();
